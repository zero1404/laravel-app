...
<section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
    <div class="container">
        <div class="row justify-content-center form-bg-image" data-background-lg="{{ asset('dashboard/img/illustrations/signin.svg') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex justify-content-between align-items-top mb-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="small text-right">{{ __('Quên mật khẩu?') }}</a>
                                @endif    
                            </div>
                            </div>
                        </div>
