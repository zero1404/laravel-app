                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-0 h3">{{ __('Tạo Tài Khoản') }} </h1>
                        </div>
                        <form method="POST" action="{{ route('register') }}" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('lastname') is-invalid @enderror"
                                        name="lastname" value="{{ old('lastname') }}" placeholder="Họ" id="lastname"
                                        autofocus required>
                                </div>
                                @error('lastname')
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="firstname" value="{{ old('firstname') }}" placeholder="Tên" id="firstname"
                                        required>
                                </div>
                                @error('firstname')
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="phone" class="form-control @error('telephone') is-invalid @enderror"
                                        name="telephone" value="{{ old('telephone') }}" placeholder="Số điện thoại"
                            ...
                            <div class="form-group">
                                ...
                                <!-- Form -->
                                <div class="form-group mb-4">
                                    <label for="confirm_password">{{ __('Nhập lại mật khẩu:') }}</label>
                                    <div class="input-group">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-gray-800">{{ __('Đăng Ký') }}</button>
                            </div>
                        </form>
